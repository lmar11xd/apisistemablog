...
public class PublicacionControlador {
    ...
    public PublicacionRespuesta listarPublicaciones(
        ...
        @RequestParam(value = "sortDir", defaultValue = AppConstantes.ORDENAR_DIRECCION_POR_DEFECTO, required = false) String ordenarDir
    ){
        return publicacionServicio.obtenerTodasLasPublicaciones(numeroPagina, tamanoPagina, ordenarPor, ordenarDir);
    }
    ...
    @PostMapping
    public ResponseEntity<PublicacionDTO> guardarPublicaicon(@Valid @RequestBody PublicacionDTO publicacionDTO){
